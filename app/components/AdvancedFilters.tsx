    ...
    <div className="space-y-2">
      ...
      {!isCollapsed && (
        <Card className="bg-white border-orange-200">
          ...
          <div className="space-y-2">
            <div className="text-sm text-orange-700" style={{ fontWeight: 900 }}>Publication Settings</div>
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  <div className="text-sm text-orange-700" style={{ fontWeight: 900 }}>Show/Hide</div>
                  <div className="space-y-2">
          ...
          {/* Genre Filter */}
          <div className="space-y-2">
            <div className="text-sm text-orange-700" style={{ fontWeight: 900 }}>Genre</div>
          ...
          {/* Year Range */}
          <div className="space-y-2">
            <div className="text-sm text-orange-700" style={{ fontWeight: 900 }}>Publication Year</div>
          ...
          {/* Title Contains */}
          <div className="space-y-2">
            <div className="text-sm text-orange-700" style={{ fontWeight: 900 }}>Titles Contain</div>
            <Input
              id="title-contains"
          ...
          {/* Exclude Words */}
          <div className="space-y-2">
            <div className="text-sm text-orange-700" style={{ fontWeight: 900 }}>Titles Do Not Contain</div>
